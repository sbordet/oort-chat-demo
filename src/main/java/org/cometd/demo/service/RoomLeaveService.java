...
/**
 * <p>{@link RoomLeaveService} performs the actions needed to leave a particular user from a particular chat room.</p>
 *
 * @see RoomJoinService
 */
...
public class RoomLeaveService {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(RoomLeaveService.class);
